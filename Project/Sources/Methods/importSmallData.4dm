...
$text:=Document to text:C1236(Get 4D folder:C485(Current resources folder:K5:16)+"personsSmall.txt")
$coll:=JSON Parse:C1218($text)
$persons:=ds:C1482.Persons.fromCollection($coll)


$text:=Document to text:C1236(Get 4D folder:C485(Current resources folder:K5:16)+"addressesSmall.txt")
$coll:=JSON Parse:C1218($text)
